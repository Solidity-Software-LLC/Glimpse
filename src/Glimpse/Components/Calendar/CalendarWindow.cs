...
public class CalendarWindow : Window
{
			...
			: base(WindowType.Toplevel)
	{
		...
		monthUpButton.Image = new Image(Assets.CaretUp.Scale(16));
		...
		monthDownButton.Image = new Image(Assets.CaretDown.Scale(16));
		...
		this.ObserveEvent(displayServer.FocusChanged)
			.ObserveOn(new GLibSynchronizationContext())
			.Where(windowRef => IsVisible && windowRef.Id != LibGdk3Interop.gdk_x11_window_get_xid(Window.Handle))
			.Subscribe(_ => Hide());
